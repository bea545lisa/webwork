<template>
  <section class="py-16 bg-gray-50 overflow-hidden">
    ...
    <div class="relative">
      <div class="absolute left-0 top-0 h-full w-32 bg-gradient-to-r from-gray-50 to-transparent z-10"></div>
      <div class="absolute right-0 top-0 h-full w-32 bg-gradient-to-l from-gray-50 to-transparent z-10"></div>
